...
@section('konten')
            ...
            <div class="card card-statistic-1">
                ...
                <div class="card-wrap">
                    <div class="card-header">
                        <h4><strong>Total Penilaian</strong></h4>
                        <h3>13</h3>
                    </div>
                    <div class="card-body">
                        {{-- {{ $penilaian }} --}}
                        ...
                        @foreach ($data as $item)
                            <li class="media">
                                ...
                                <div class="media-body">
                                    <div
                                        class="float-right @if ($item->status == 'selesai') text-success @else text-warning @endif">
                                        {{ $item->status }}</div>
    ...
    {{-- @php
    $persen = 100;
    $persenbelum = $terkirim / $penilaian * $persen;
    $persenproses = $proses / $penilaian * $persen;
    $persenselesai = $selesai / $penilaian * $persen;
@endphp --}}
    {{-- @endif --}}
@endsection
